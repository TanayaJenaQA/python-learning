...
SCHOOL = "MKC HIGH SCHOOL"  # constant
...
print(
    ...
    f"Constant School Name : {SCHOOL} a : {a} b : {b} c :{c}"
...
print(
    ...
    f"Constant School Name type: {type(SCHOOL)} a type: {type(a)} b type: {type(b)} c type:{type(c)}"
